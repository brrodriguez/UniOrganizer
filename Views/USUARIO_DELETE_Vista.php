        ...
        <div class="container" >
            <form  id="form" name="form" action='USUARIO_Controller.php?user=user'  method='post'   enctype="multipart/form-data">
                <div class="form-group" >
                    <label class="control-label" ><?php echo $strings['Eliminar Usuario']; ?></label><br>
                </div>
				...
				<div class="form-group">
                    ...
                    <input class="form" id="tipoUsuario" name="tipoUsuario" size="10" type="int" readonly="true" value="<?php echo $this->valores['tipoUsuario']; ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form" id="niu" name="niu" size="20" type="text" readonly="true" value="<?php echo $this->valores['niu']; ?>">
                </div>
